...
in
{
  wayland.windowManager.hyprland = {
    ...
    # Rely on this: https://mynixos.com/home-manager/option/wayland.windowManager.hyprland.settings
    ...
    settings = {
      ...
      bind = [
        ...
        "Super, F, exec, thunar"
        "Super, Q, exec, kitty --title 'TF Euler - \"Sine Pari\"'"
        "Super, P, exec, focuswriter"
        "Super, A, exec, rofi -show combi -combi-modes \"window,drun\" -modes combi"
