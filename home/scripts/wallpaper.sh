...
wallpapers=("${prefix}/Space Travel.jpg" "${prefix}/1310201.jpeg" "${prefix}/1310702.png" "${prefix}/436854.jpg" "${prefix}/1140292.jpg" "${prefix}/1338111.png" "${prefix}/1358147.png" "${prefix}/9.jpg")
