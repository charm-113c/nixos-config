...
wallpapers=("${prefix}/1358147.png" "${prefix}/127659704_p1.png" "${prefix}/131409687_p0.jpg" "${prefix}/83681852_p0.png" "${prefix}/139614886_p0.png" "${prefix}/Heaven Piercer.jpg")
