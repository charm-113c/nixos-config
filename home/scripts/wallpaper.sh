...
wallpapers=("${prefix}/129850683_p0.png" "${prefix}/127659704_p1.png" "${prefix}/131409687_p0.jpg" "${prefix}/56436213_p0.png" "${prefix}/1338168.png" "${prefix}/1310201.jpeg" "${prefix}/136998207_p0.jpg" "${prefix}/136221169_p0.jpg")
