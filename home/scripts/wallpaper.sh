...
wallpapers=("${prefix}/129850683_p0.png" "${prefix}/127659704_p1.png" "${prefix}/131409687_p0.jpg" "${prefix}/93892148_p0.jpg" "${prefix}/135100174_p0.jpg" "${prefix}/1310201.jpeg" "${prefix}/104651378_p0.jpg" "${prefix}/136221169_p0.jpg")
