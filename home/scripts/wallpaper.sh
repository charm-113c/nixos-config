...
wallpapers=("${prefix}/140556576_p0.png" "${prefix}/1396456.png" "${prefix}/Space Travel.jpg" "${prefix}/127659704_p1.png" "${prefix}/Heaven Piercer.jpg" "${prefix}/Junk Dog.jpg" "${prefix}/Where Dreams Start.jpg")
